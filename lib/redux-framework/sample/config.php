...
$opt_name = 'sr_redux';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'search-and-replace' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'search-and-replace' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'search-and-replace' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'search-and-replace' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-extensions',
	'href'  => 'redux.io/extensions',
	'title' => __( 'Extensions', 'search-and-replace' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	// $args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'search-and-replace' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'search-and-replace' ) . '</p>';
}

// Add content after the form.
// $args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'search-and-replace' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'search-and-replace' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'search-and-replace' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'search-and-replace' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'search-and-replace' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'search-and-replace' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Basic Fields', 'search-and-replace' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'search-and-replace' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Editors', 'search-and-replace' ),
		'id'               => 'editor',
		'customizer_width' => '100px',
		'icon'             => 'el el-edit',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Color Selection', 'search-and-replace' ),
		'id'    => 'color',
		'icon'  => 'el el-brush',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Design Fields', 'search-and-replace' ),
		'id'    => 'design',
		'icon'  => 'el el-wrench',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Media Uploads', 'search-and-replace' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Presentation Fields', 'search-and-replace' ),
		'id'    => 'presentation',
		'icon'  => 'el el-screen',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Switch / Button Set', 'search-and-replace' ),
		'id'    => 'switch_buttonset',
		'icon'  => 'el el-cogs',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Select Fields', 'search-and-replace' ),
		'id'    => 'select',
		'icon'  => 'el el-list-alt',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Slider / Spinner', 'search-and-replace' ),
		'id'    => 'slider_spinner',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Additional Types', 'search-and-replace' ),
		'id'    => 'additional',
		'icon'  => 'el el-magic',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Advanced Features', 'search-and-replace' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Disabling', 'search-and-replace' ),
		'icon'  => 'el el-lock',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Redux Extensions', 'search-and-replace' ),
		'id'    => 'redux-extensions',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'search-and-replace' ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
	)
);
...
if ( file_exists( $dir . '/../README.md' ) ) {
	$section = array(
		'icon'   => 'el el-list-alt',
		'title'  => esc_html__( 'Documentation', 'search-and-replace' ),
		'fields' => array(
			array(
...
Redux::set_section(
	...
	array(
		'icon'            => 'el el-list-alt',
		'title'           => esc_html__( 'Customizer Only', 'search-and-replace' ),
		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'search-and-replace' ) . '</p>',
		'customizer_only' => true,
		'fields'          => array(
			array(
				'id'              => 'opt-customizer-only',
				'type'            => 'select',
				'title'           => esc_html__( 'Customizer Only Option', 'search-and-replace' ),
				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'search-and-replace' ),
				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'search-and-replace' ),
				'customizer_only' => true,
				'options'         => array(
					'1' => esc_html__( 'Opt 1', 'search-and-replace' ),
					'2' => esc_html__( 'Opt 2', 'search-and-replace' ),
					'3' => esc_html__( 'Opt 3', 'search-and-replace' ),
				),
				'default'         => '2',
			),
		),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Quick and Easy', 'search-and-replace' ),
		'id'               => 'quick-easy',
...
require_once Redux_Core::$dir . '../sample/sections/quick-easy/quick-easy.php';

// -> START ListItem.
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'List Item', 'search-and-replace' ),
		'id'               => 'list-item',
		'customizer_width' => '500px',
		'icon'             => 'el el-edit',
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Testimonials', 'search-and-replace' ),
		'id'               => 'testimonials',
		'customizer_width' => '500px',
		'icon'             => 'el el-edit',
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Call to Action', 'search-and-replace' ),
		'id'               => 'cta',
		'customizer_width' => '500px',
		'icon'             => 'el el-edit',
	)
); 
require_once Redux_Core::$dir . '../sample/sections/cta/cta.php';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Experience', 'search-and-replace' ),
		'id'               => 'experience',
		'customizer_width' => '500px',
		'icon'             => 'el el-edit',
	)
); 
require_once Redux_Core::$dir . '../sample/sections/experience/experience.php';
...
require_once Redux_Core::$dir . '../sample/sections/footer/footer-copyright.php';
/*
 * <--- END SECTIONS
 */
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'search-and-replace' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'search-and-replace' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'search-and-replace' );
